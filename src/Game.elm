    ...
    div [ class "content" ]
        (case model.state of
            Romaji ->
                ...
                in
                [ Html.h1 [ style "font-size" ("min(calc(100vw / " ++ String.fromInt letters ++ " - 20px), calc(50cqb / " ++ String.fromInt letters ++ "))"), style "text-align" "center", style "line-height" "1" ] [ text model.word.str ]
